...
define([
    ...
    './EQ/plugin', //Equipment Config Plugin
    './themes/schmucker', //Schmucker theme using WARR colors
    './WARR_BRANDING/plugin',
    './Controll/plugin',
    './Import_Controll_EQ/plugin',
    './BackendConnection/plugin',
    './Sequence/plugin',
    './Calib/plugin',
    './RPC/plugin'
    ...
    ExampleTags,
    EQ, //Equipment Config Plugin
    Schmucker, //Schmucker Theme
    WARR_BRANDING,
    Controll,
    Import_Controll,
    BackendConnection,
    ...
    // CUSTOM PLUGINS
    plugins.EQ = EQ.default; //Equipment Config Plugin
    plugins.Schmucker = Schmucker.default; //Schmucker theme
    plugins.WARR_BRANDING = WARR_BRANDING.default; //WARR + EX-UI Branding
    plugins.Controll = Controll;
    plugins.Import_Controll = Import_Controll.default;
    plugins.Sequence = Sequence;
    plugins.Calib = Calib;
    plugins.RPC = RPC;
    plugins.BackendConnection = BackendConnection.default;
    return plugins;
});
