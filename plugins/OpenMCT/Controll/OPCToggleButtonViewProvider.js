...
define([
    './components/OPCToggleButton.vue',
    'vue'
], function (
    OPCToggleButton,
    Vue
) {
    function OPCToggleButtonViewProvider(openmct) {
        return {
            key: 'OPCToggleButton',
            name: 'OPC Toggle Button',
            cssClass: 'icon-circle',
            canView: function (domainObject) {
                return domainObject.type === 'OPCToggleButton';
            },
                ...
                return {
                    show: function (element) {
                        component = new Vue({
                            el: element,
                            components: {
                                OPCToggleButtonComponent: OPCToggleButtonComponent.default
                            ...
                            template: '<OPC-Toggle-Button-component></OPC-Toggle-Button-component>'
                        });
                    },
    ...
    return OPCToggleButtonViewProvider;
});
